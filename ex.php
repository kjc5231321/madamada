...
(function (E, B) {
        ...
        c = function () {
            ...
            b.extend({
                ...
                makeArray: function (j, s) {
                    ...
                    if (j != null) {
                        var z = b.type(j);
                        j.length == null || z === "string" || z === "function" || z === "regexp" || b.isWindow(
                            j
                        )
                            ? M.call(v, j)
                            : b.merge(v, j)
                ...
                uaMatch: function (j) {
                    j = j.toLowerCase();
                    j = L.exec(j) || g.exec(j) || i.exec(j) || j.indexOf("compatible") < 0 && n.exec(
                        j
                    ) || [];
                    return {
                        browser: j[1] || "",
    ...
    (function () {
        ...
        d.innerHTML = "   <link/><table></table><a href='/a' style='color:red;float:left;opacity:.55;" +
    ...
    c.extend({
        ...
        attr: function (a, b, d, e) {
            ...
            if ((b in a || a[b] !== B) && e && !h) {
                if (f) {
                    b === "type" && Ua.test(a.nodeName) && a.parentNode && c.error(
            ...
            if (!a.attributes[b] && a.hasAttribute && !a.hasAttribute(b)) 
                return B;
            a = !c.support.hrefNormalized && e && h
                ? a.getAttribute(b, 2)
                : a.getAttribute(b);
            return a === null
                ? B
    ...
    c.event = {
        ...
        trigger: function (a, b, d, e) {
            ...
            if (!e) {
                ...
                if (!d) {
                    ...
                    c
                        .event
                        .global[f] && c.each(c.cache, function () {
                        this.events && this.events[f] && c
                            .event
                            .trigger(a, b, this.handle.elem)
                    })
                }
            ...
            if (!a.isPropagationStopped() && e) 
                ...
                var k = f.replace(X, ""),
                    ...
                    x = c
                        .event
                        .special[k] || {};
                if ((!x._default || x._default.call(d, a) === false) && !o && !(e && e.nodeName && c.noData[
                    e
                        .nodeName
                        .toLowerCase()
                ])) {
        ...
        props: (
            ...
            "ctrlKey currentTarget data detail eventPhase fromElement handler keyCode layer" +
            "X layerY metaKey newValue offsetX offsetY pageX pageY prevValue relatedNode re" +
            "latedTarget screenX screenY shiftKey srcElement target toElement view wheelDel" +
            "ta which"
        ).split(" "),
        fix: function (a) {
            if (a[c.expando]) 
            ...
            if (a.pageX == null && a.clientX != null) {
                b = t.documentElement;
                d = t.body;
                a.pageX = a.clientX + (b && b.scrollLeft || d && d.scrollLeft || 0) - (
                    b && b.clientLeft || d && d.clientLeft || 0
                );
                a.pageY = a.clientY + (b && b.scrollTop || d && d.scrollTop || 0) - (
                    b && b.clientTop || d && d.clientTop || 0
                )
            }
            if (a.which == null && (a.charCode != null || a.keyCode != null)) 
                a.which = a.charCode != null
                    ? a.charCode
                    : a.keyCode;
        ...
        special: {
            ...
            live: {
                add: function (a) {
                    c
                        .event
                        .add(this, Y(a.origType, a.selector), c.extend({}, a, {
                            handler: Ka,
                            guid: a.handler.guid
                        }))
                },
                remove: function (a) {
                    c
                        .event
                        .remove(this, Y(a.origType, a.selector), a)
                }
            },
            beforeunload: {
    ...
    c.each(
        (
            ...
            "it keydown keypress keyup error"
        ).split(" "),
        function (a, b) {
            c.fn[b] = function (d, e) {
                if (e == null) {
    ...
    (function () {
                ...
                find: {
                    ID: function (g, i, n) {
                        if (typeof i.getElementById !== "undefined" && !n) 
                            return (g = i.getElementById(g[1])) && g.parentNode
                                ? [g]
                                : []
                        },
                    NAME: function (g, i) {
        ...
        try {
            Array
                .prototype
                .slice
                .call(t.documentElement.childNodes, 0)
        } catch (J) {
            C = function (g, i) {
                var n = 0,
                    m = i || [];
        ...
        if (t.documentElement.compareDocumentPosition) 
            w = function (g, i) {
                ...
                if (!g.compareDocumentPosition || !i.compareDocumentPosition) 
                    return g.compareDocumentPosition
                        ? -1
                        : 1;
                return g.compareDocumentPosition(i) & 4
                    ? -1
                    : 1
            };
        else {
                ...
                o.find.ID = function (m, p, q) {
                    if (typeof p.getElementById !== "undefined" && !q) 
                        return (p = p.getElementById(m[1]))
                            ? p.id === m[1] || typeof p.getAttributeNode !== "undefined" && p
                                .getAttributeNode(
                                    "id"
                                )
                                .nodeValue === m[1]
    ...
    c
        ...
        .extend({
            ...
            add: function (a, b) {
                ...
                return this.pushStack(
                    !d[0] || !d[0].parentNode || d[0].parentNode.nodeType === 11 || !e[0] || !e[0].parentNode || e[0].parentNode.nodeType === 11
                        ? e
                        : c.unique(e)
                )
            },
        ...
        .extend({
            text: function (a) {
                ...
                if (typeof a !== "object" && a !== B) 
                    return this
                        .empty()
                        .append((this[0] && this[0].ownerDocument || t).createTextNode(a));
                return c.text(this)
            },
            wrapAll: function (a) {
                if (c.isFunction(a)) 
            ...
            after: function () {
                if (this[0] && this[0].parentNode) 
                    return this.domManip(arguments, false, function (b) {
                        this
                            .parentNode
                            .insertBefore(b, this.nextSibling)
                    });
                else if (arguments.length) {
                    var a = this.pushStack(this, "after", arguments);
                    a
                        .push
                        .apply(a, c(arguments[0]).toArray());
                    return a
                }
            },
            remove: function (a, b) {
                    ...
                    if (typeof l === "string" && !eb.test(l)) 
                        ...
                        if (!c.support.tbody) {
                            ...
                            for (o = k.length - 1; o >= 0; --o) 
                                c.nodeName(k[o], "tbody") && !k[o].childNodes.length && k[o]
                                    .parentNode
                                    .removeChild(k[o])
                            }
                        !c.support.leadingWhitespace && $.test(l) && r.insertBefore(
                            b.createTextNode($.exec(l)[0]),
                            r.firstChild
                        );
                        l = r.childNodes
                    }
    ...
    if (c.expr && c.expr.filters) {
        c.expr.filters.hidden = function (a) {
            ...
            return a.offsetWidth === 0 && b === 0 || !c.support.reliableHiddenOffsets && (
                a.style.display || c.css(a, "display")
            ) === "none"
        };
    ...
    c.extend({
        ...
        ajax: function (a) {
            ...
            b.global && c.active++ === 0 && c
                .event
                .trigger("ajaxStart");
            o = (o = sb.exec(b.url)) && (
                o[1] && o[1].toLowerCase() !== location.protocol || o[2].toLowerCase() !== location.host
            );
            ...
            if (w) {
                ...
                try {
                    ...
                    if (b.ifModified) {
                        c.lastModified[b.url] && w.setRequestHeader(
                            "If-Modified-Since",
    ...
    c.extend({
        ...
        handleComplete: function (a, b, d) {
            ...
            a.global && c.active-- === 1 && c
                .event
                .trigger("ajaxStop")
        },
        triggerGlobal: function (a, b, d) {
            (
                a.context && a.context.url == null
                    ? c(a.context)
                    : c.event
            ).trigger(b, d)
        },
    ...
    c.fx.prototype = {
        ...
        show: function () {
            this
                .options
                .orig[this.prop] = c.style(this.elem, this.prop);
        ...
        step: function (a) {
            ...
            if (d) {
                ...
                this.pos = c.easing[
                    this.options.specialEasing && this
                        .options
                        .specialEasing[this.prop] || b
    ...
    c.offset = {
        initialize: function () {
            ...
            b.innerHTML = "<div style='position:absolute;top:0;left:0;margin:0;border:5px solid #000;padd" +
                    "ing:0;width:1px;height:1px;'><div></div></div><table style='position:absolute;" +
                    "top:0;left:0;margin:0;border:5px solid #000;padding:0;width:1px;height:1px;' c" +
    ...
    c.each([
        ...
        c.fn["inner" + b] = function () {
            return this[0]
                ? parseFloat(c.css(this[0], d, "padding"))
                : null
        };
        ...
        c.fn[d] = function (e) {
            ...
            if (c.isWindow(f)) 
                return f.document.compatMode === "CSS1Compat" && f
                    .document
                    .documentElement["client" + b] || f
                    .document
                    .body["client" + b];
...
var EC_PlusAppBridge = (function(){
    ...
    return {
        ...
        unserialize: function (sParam) {
            ...
            objParam = {};
            $.each(aParam, function(iKey, sValue) {
    ...
    displayMore : function(iActive, iDisplayGroup, iCategoryNo, iCount, iSortMethod, bCache, sSupplierCode, bInitMore, sSoldoutDisplay) {
        ...
        var EC_MORE = (function() {
            ...
            function getLiTemplate(sPos)
            {
                ...
                var $li = $.fn[sPos].apply($(sModuleHtmlForVDOM).find('ul').first().children('li'));
                var sLiHtmlForVDOM = $('<ul>').append($li).html();
